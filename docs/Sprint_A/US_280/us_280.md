...
**Test 1:** Método reverterElevadorNoMapa() muda os tipos pontos corretamente </br>
**Test 2:** Serviço retorna erro quando o edifício não existe</br>
**Test 3:** Serviço retorna erro quando o elevador não existe </br>
**Test 4:** Serviço retorna erro quando a nova posição não é válida </br>
**Test 5:** Serviço retorna erro quando os argumentos da posição (x,y,orientação) não foi passado por parâmetro e os outros foram  </br>
