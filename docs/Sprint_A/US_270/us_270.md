# US 207 - 	Criar um elevador num edifício
...
* O elevador deve ser adicionado ao mapa de cada piso
...
* **Teste 5:** Se a posição não for válida serviço retorna erro  
* **Teste 6:** Se os pisos escolhidos não forem válidos serviço retorna erro  
* (...)
