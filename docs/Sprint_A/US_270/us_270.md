# US 207 - 	Como gestor de campus, quero criar um elevador num edifício
...
* Gestor de campus - quer criar um elevador

**Condições anteriores**
* Deve exitir um edifício criado
...
1. Gestor de campus insere o edifício e a posição onde quer criar o elevador
2. Sistema informa o sucesso da operação

**Other scenarios**

**2.a.** O sistema verifica que a posição inserida não é válida
