...
**Test 1:** O serviço retorna erro quando pelo menos um dos códigos do edifício não é válido </br>
**Test 2:** O serviço retorna erro quando não existem passagens </br>
**Test 3:** O serviço retorna a lista correta quando são fornecidos 2 códigos válidos </br>
**Test 4:** O serviço retorna a lista correta quando não são fornecidos códigos</br>
