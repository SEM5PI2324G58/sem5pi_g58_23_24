...
Esta US vai permitir a listagem dos elevadores de um edifíco 
...
**Test 1:** O serviço retorna erro quando não existem elevadores </br>
**Test 2:** O serviço retorna erro quando não existe o edifício </br>
(...)
