...
export default class UserInteraction {
    ...
    constructor(scene: THREE.Scene, renderer: THREE.WebGLRenderer, lights: Lights/*, fog: Fog*/, object: THREE.Object3D/*, animations: Animations*/) {
        function colorCallback(object: { color: THREE.Color }, color: string) {
            object.color.set(color);
        }

        function shadowsCallback(enabled: boolean) {
            scene.traverseVisible(function (child: THREE.Object3D) {
