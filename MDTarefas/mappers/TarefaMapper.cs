    ...
    public class TarefaMapper {
        public static TarefaDTO toDTO(Tarefa tarefa) {
            ...
            if (tarefa is Vigilancia) {
                ...
                return new TarefaDTO(vigilancia.Id, vigilancia.Percurso.PercursoString, vigilancia.Estado.EstadoString.ToString(), vigilancia.EmailRequisitor.Email,
                ...
                return new TarefaDTO(pickUpDelivery.Id, pickUpDelivery.Percurso.PercursoString, pickUpDelivery.Estado.EstadoString.ToString(), pickUpDelivery.EmailRequisitor.Email,
