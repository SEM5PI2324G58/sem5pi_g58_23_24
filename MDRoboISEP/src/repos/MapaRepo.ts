    ...
    public async save(mapa: Mapa): Promise<Mapa>{
        ...
        try{
            if (mapaDocument === null){
                ...
                mapaDocument.abcissa = mapa.returnAbcissaPassagem();
                mapaDocument.ordenada = mapa.returnOrdenadaPassagem();
                mapaDocument.orientacaoPassagem = mapa.returnOrientacaoPassagem();
                mapaDocument.xCoord = mapa.returnXCoordElevador();
                mapaDocument.yCoord = mapa.returnYCoordElevador();
                mapaDocument.orientacaoElevador = mapa.returnOrientacaoElevador();
                mapaDocument.nome = mapa.returnNomeSala();
                mapaDocument.abcissaA = mapa.returnAbcissaASala();
                mapaDocument.ordenadaA = mapa.returnOrdenadaASala();
                mapaDocument.abcissaB = mapa.returnAbcissaBSala();
                mapaDocument.ordenadaB = mapa.returnOrdenadaBSala();
